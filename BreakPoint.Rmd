...
breakPoint <- function(match, firstName, lastName) {
  ...
  bpWon <- bpData$point_winner == paste(firstName, lastName)
  ...
  colnames(set1_DF) <- c("Count of Break Points Won", "Break Point Win Percentage")
  ...
  colnames(set2_DF) <- c("Count of Break Points Won", "Break Point Win Percentage")
  ...
  if (any(isSet3)) {
    ...
    colnames(set3_DF) <- c("Count of Break Points Won", "Break Point Win Percentage")
  ...
  colnames(total_DF) <- c("Count of Break Points Won", "Break Point Win Percentage")
