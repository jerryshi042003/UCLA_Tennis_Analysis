...
quick_stats <- function(data, player){
  ...
  error_table <- temp_df %>% 
    ...
    summarise("fhErrorNet" = length(which((returnData == "Forehand" | shotType == "Forehand") & isErrorNet == 1)),
              "fhErrorWide" = length(which(((returnData == "Forehand" | shotType == "Forehand") & 
                                         (isErrorWideL == 1 | isErrorWideR == 1)))),
              "fhErrorLong" = length(which((returnData == "Forehand" | shotType == "Forehand") & isErrorLong == 1)),
              "bhErrorNet" = length(which((returnData == "Backhand" | shotType == "Backhand") & isErrorNet == 1)),
              "bhErrorWide"= length(which(((returnData == "Backhand" | shotType == "Backhand") & 
                                        (isErrorWideL == 1 | isErrorWideR == 1)))),
              "bhErrorLong" = length(which((returnData == "Backhand" | shotType == "Backhand") & isErrorLong == 1)))
