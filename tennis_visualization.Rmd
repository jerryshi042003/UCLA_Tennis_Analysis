...
# Loading in Data
```{r}
pointdata <- read.csv("C:/Users/jerry/Documents/Ucla/BSA/CSV shot to Point/R Code/GovindNanda_TylerZink_Point_ForVisuals.csv")
shotdata <- read.csv("C:/Users/jerry/Documents/Ucla/BSA/CSV shot to Point/R Code/GovindNanda_TylerZink_Shot.csv")
...
grid1 <- readPNG("C:/Users/jerry/Documents/Ucla/BSA/CSV shot to Point/R Code/serve_placement_court_new.png")
grid2 <- readPNG("C:/Users/jerry/Documents/Ucla/BSA/CSV shot to Point/R Code/Court_Image_Volleys.png")
```

# Summary Stats
```{r}
col_names <- c("1st Serve In %", "2nd Serve In %", "1st Serve Won %", "2nd Serve Won %", "Service Points Won %", "Return Points Won %", "Ace (Count)",
               "Double Fault (Count)")
